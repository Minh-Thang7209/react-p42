...
/*
JS/TS мають власні Base64 інструменти, але вони працюють тільки для ASCII символів. При спробі кодувати кирилиццю
виниквають винятки.
Корекція: Юнікод-символи декодуємо у байт-послідовності, які кодуємо як звичайні ASCII
*/